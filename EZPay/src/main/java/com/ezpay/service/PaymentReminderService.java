...
public class PaymentReminderService {
 ...
 /**
    ...
    public void sendReminderEmails() {
        List<PaymentReminder> reminders = paymentReminderRepository.findDueReminders(new Date());
        ...
        for (PaymentReminder reminder : reminders) {
            ...
            if (userOpt.isPresent()) {
                ...
                String subject = "EZPay-Payment Reminder: Payment Due Soon";
                String message = generateEmailMessage(reminder, user.getUsername());
    ...
    /**
     * Generate email message content based on the reminder and user.
     */
