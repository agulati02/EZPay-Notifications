...
INSERT INTO payment_reminder (reminder_id, user_id, amount, due_date, status) VALUES ('R03U01', 'U01', 320.50, TO_DATE('2024-09-21', 'YYYY-MM-DD'), 'Completed');
INSERT INTO payment_reminder (reminder_id, user_id, amount, due_date, status) VALUES ('R04U01', 'U01', 450.00, TO_DATE('2024-09-19', 'YYYY-MM-DD'), 'Pending');
...
INSERT INTO payment_reminder (reminder_id, user_id, amount, due_date, status) VALUES ('R02U02', 'U02', 500.00, TO_DATE('2024-09-12', 'YYYY-MM-DD'), 'Pending');
...
INSERT INTO payment_reminder (reminder_id, user_id, amount, due_date, status) VALUES ('R01U03', 'U03', 850.30, TO_DATE('2024-09-13', 'YYYY-MM-DD'), 'Pending');
INSERT INTO payment_reminder (reminder_id, user_id, amount, due_date, status) VALUES ('R02U03', 'U03', 950.00, TO_DATE('2024-09-19', 'YYYY-MM-DD'), 'Completed');
INSERT INTO payment_reminder (reminder_id, user_id, amount, due_date, status) VALUES ('R03U03', 'U03', 150.00, TO_DATE('2024-09-21', 'YYYY-MM-DD'), 'Pending');
INSERT INTO payment_reminder (reminder_id, user_id, amount, due_date, status) VALUES ('R04U03', 'U03', 275.50, TO_DATE('2024-10-11', 'YYYY-MM-DD'), 'Pending');

INSERT INTO payment_reminder (reminder_id, user_id, amount, due_date, status) VALUES ('R01U04', 'U04', 360.00, TO_DATE('2024-09-18', 'YYYY-MM-DD'), 'Pending');
INSERT INTO payment_reminder (reminder_id, user_id, amount, due_date, status) VALUES ('R02U04', 'U04', 450.25, TO_DATE('2024-09-18', 'YYYY-MM-DD'), 'Completed');
INSERT INTO payment_reminder (reminder_id, user_id, amount, due_date, status) VALUES ('R03U04', 'U04', 525.75, TO_DATE('2024-09-28', 'YYYY-MM-DD'), 'Pending');
